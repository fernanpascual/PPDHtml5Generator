...
var camera = {
	...
	zoom : 1,
	display : {
		x : document.querySelector('#head').offsetWidth/2,
		y : document.querySelector('#head').offsetHeight/2,
		z : 0
	}
};
var affine = {
...
vertex3d.prototype = {
	...
	var canvasWidth = document.querySelector('#head').offsetWidth;
	var canvasHeight = document.querySelector('#head').offsetHeight;
	...
	window.onresize = function() {
		canvas.width = document.querySelector('#head').offsetWidth;
		canvas.height = document.querySelector('#head').offsetHeight;
		camera.display.x = document.querySelector('#head').offsetWidth/2;
		camera.display.y = document.querySelector('#head').offsetHeight/2;
	};
	...
	var textSet = [
		{text:"PPD", sphereRadius:80, sphereSpace:70, unitTime:120, time:4000},
		{text:"HTML5", sphereRadius:80, sphereSpace:70, unitTime:50, time:2000},
		{text:"CODE", sphereRadius:80, sphereSpace:70, unitTime:100, time:4000},
		{text:"GENERATOR", sphereRadius:100, sphereSpace:60, unitTime:100, time:3000}
	];
	...
	var start = function() {
		...
		setInterval(function() {
			...
			ctx.fillRect(0, 0, document.querySelector('#head').offsetWidth, document.querySelector('#head').offsetHeight);
			ctx.strokeStyle = strokeColor;
			update();
			draw();
		}, 1000/60);
	...
	document.querySelector('#head').onmousemove = function(e) {
	camera.rotate.x = e.pageY/document.querySelector('#head').offsetHeight * 180 - 90;
	camera.rotate.y = e.pageX/document.querySelector('#head').offsetWidth * 180 - 90;
